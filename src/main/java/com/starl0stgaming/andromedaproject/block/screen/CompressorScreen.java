package com.starl0stgaming.andromedaproject.block.screen;
...
public class CompressorScreen extends HandledScreen<CompressorScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier("andromedaproject", "textures/gui/machine/machine_container.png");
